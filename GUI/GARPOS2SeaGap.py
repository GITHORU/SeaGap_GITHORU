...
def GARPOS2SeaGap(path_obs, path_svp, path_ini, path_pxp_o, path_obs_o, path_ssp_o, path_ant_o):
...
if __name__ == '__main__':
    path_obs = "data/GARPOS/GNSS-A_data_200820/obsdata/MYGI/MYGI.1103.meiyo_m4-obs.csv"
    path_svp = "data/GARPOS/GNSS-A_data_200820/obsdata/MYGI/MYGI.1103.meiyo_m4-svp.csv"
    path_ini = "data/GARPOS/GNSS-A_data_200820/initcfg/MYGI/MYGI.1103.meiyo_m4-initcfg.ini"

    path_pxp_o = "data/output/pxp-ini.inp"
    path_obs_o = "data/output/obsdata.inp"
    path_ssp_o = "data/output/ss_prof.inp"
    path_ant_o = "data/output/tr-ant.inp"
